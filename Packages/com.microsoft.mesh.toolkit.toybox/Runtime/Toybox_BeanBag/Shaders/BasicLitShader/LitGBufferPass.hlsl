#ifndef CUSTOM_UNIVERSAL_LIT_GBUFFER_PASS_INCLUDED
#define CUSTOM_UNIVERSAL_LIT_GBUFFER_PASS_INCLUDED
...
#if defined(_PARALLAXALPHAMAP) && (SHADER_TARGET >= 30)
...
Varyings LitGBufferPassVertex(Attributes input)
{
    ...
    output.color = Gamma20ToLinear(input.color);
...
#endif
    ApplyPerPixelDisplacement(viewDirTS, input.uv, parallaxAlpha);
#endif
