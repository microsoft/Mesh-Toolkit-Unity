...
namespace MeshApp.Animations
{
    ...
    [UserCreatable(false)]
    public class OculusTouchQuest2RightAnimationAnimator : AnimationNode
    {
        ...
        protected OculusTouchQuest2RightAnimationAnimator(in Guid ahandle, bool transfer)
        ...
        internal static OculusTouchQuest2RightAnimationAnimator GetOrCreateInstance(in Guid cookie, bool transfer)
        {
            var result = GetOrCreateDomObject(
                cookie,
                transfer,
                (handle, t) => new OculusTouchQuest2RightAnimationAnimator(handle, transfer: t));

            return result as OculusTouchQuest2RightAnimationAnimator;
        }
    }
}