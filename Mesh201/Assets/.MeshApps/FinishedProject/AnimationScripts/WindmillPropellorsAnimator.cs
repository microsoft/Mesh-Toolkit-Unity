...
namespace MeshApp.Animations
{
    ...
    [UserCreatable(false)]
    public class WindmillPropellorsAnimator : AnimationNode
    {
        private readonly float[] _baseLayerSpeeds = { 1F, 1F, };

        protected WindmillPropellorsAnimator(in Guid ahandle, bool transfer)
        ...
        internal static WindmillPropellorsAnimator GetOrCreateInstance(in Guid cookie, bool transfer)
        {
            var result = GetOrCreateDomObject(
                cookie,
                transfer,
                (handle, t) => new WindmillPropellorsAnimator(handle, transfer: t));

            return result as WindmillPropellorsAnimator;
        }
    }
}